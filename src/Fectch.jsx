...
const Fetch = () => {
  ...
  useEffect(() => {
    fetch(`${process.env.PUBLIC_URL}/data.json`)
      ...
      .catch((error) => {
        ...
        // You can show a fallback message or alert
      });
  }, []);
  ...
  // Filter countries by region and search text
  ...
  // Dynamic regions based on the available data
          ...
          displayedCountries.map((country, index) => (
            ...
            >
              <img
                className="flag-img"
                src={
                  country.flags.png || country.flags.svg || "default-flag.png"
                }
                alt={country.name}
              />
              <div className="country-info">
